...
// The `verify` callback captures the raw body bytes BEFORE parsing
// so bountyController can use req.rawBody for HMAC verification.
// JSON.stringify(req.body) does NOT reproduce the exact original bytes.
